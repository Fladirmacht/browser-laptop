...
module.exports = function (windowState, action) {
  switch (action.actionType) {
    ...
    case appConstants.APP_TAB_DRAG_STARTED:
      windowState = tabDraggingState.setWindowStateDragSourceTabId(windowState, action.dragSourceData.sourceTabId)
    ...
    case appConstants.APP_TAB_DRAG_CANCELLED:
      // delete state data
      windowState = tabDraggingState.clearWindowStateDragSourceTabId(windowState)
      break
